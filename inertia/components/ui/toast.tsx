      ...
      <div className="p-4">
        <div className="flex items-start">
          ...
          <div className="ml-4 flex-shrink-0 flex">
            <button
              className={`${styles.bg} rounded-md inline-flex ${styles.message} hover:${styles.title} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500`}
              onClick={() => onClose(id)}
            >

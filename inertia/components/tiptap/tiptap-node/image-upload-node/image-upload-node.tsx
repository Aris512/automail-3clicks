      ...
      <div className="tiptap-image-upload-preview-content">
        <div className="tiptap-image-upload-file-info">
          {isImage && imagePreview && (
            <div className="tiptap-image-preview-thumbnail">
              <img src={imagePreview} alt={fileItem.file.name} />
            </div>
          )}
          {isPDF && pdfUrl && (
          ...
          <div className="tiptap-image-upload-details">
            ...
            <span className="tiptap-image-upload-subtext">
              {isPDF ? `${numPages} pages • ${formatFileSize(fileItem.file.size)}` : formatFileSize(fileItem.file.size)}
            </span>
          </div>
        </div>
